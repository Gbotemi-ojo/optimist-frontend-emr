  ...
  const handleAddManualProvisionalDiagnosis = () => {
    ...
    if (trimmedDiagnosis) {
      if (!formData.provisionalDiagnosis.includes(trimmedDiagnosis)) {
        setFormData(prevData => ({
          ...prevData,
          provisionalDiagnosis: [...prevData.provisionalDiagnosis, trimmedDiagnosis].sort()
        }));
  ...
  const handleAddManualTreatmentPlan = () => {
    ...
    if (trimmedPlan) {
      if (!formData.treatmentPlan.includes(trimmedPlan)) {
        setFormData(prevData => ({
          ...prevData,
          treatmentPlan: [...prevData.treatmentPlan, trimmedPlan].sort()
        }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        medicationE: false, medicationPUD: false, medicationBloodDisorder: false, medicationAllergy: false, medicationHIV: false, medicationHepatitis: false,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <section className="form-section">
          ...
          <div className="form-grid">
            ...
            {/* MODIFIED: Provisional Diagnosis with Manual Input */}
            ...
            {/* MODIFIED: Treatment Plan with Manual Input */}
            <div className="form-group full-width-grid-item">

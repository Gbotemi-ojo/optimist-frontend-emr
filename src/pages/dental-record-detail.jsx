    ...
    const fetchRecordDetails = async () => {
      ...
      try {
        ...
        if (recordResponse.ok) {
          ...
          console.log("Data received for Dental Record:", recordData);
    ...
    <div className="record-detail-container">
      ...
      <section className="detail-section">
        ...
        <div className="detail-grid">
          ...
          <div className="detail-item">
            {/* Display date nicely */}
            <strong>Record Date:</strong> <span>{record.createdAt ? new Date(record.createdAt).toLocaleDateString() : 'N/A'}</span>
          </div>
          <div className="detail-item">
      ...
      <section className="detail-section">
        ...
        <div className="medication-tags-group">
          ...
          {/* CORRECTED LOGIC: This condition now correctly checks all medication properties */}
          {!record.medicationS && !record.medicationH && !record.medicationA && !record.medicationD &&
           ...
           !record.medicationHIV && !record.medicationHepatitis &&
        ...
        <div className="detail-grid">
          ...
          <div className="detail-item full-width">
           ...
           <div className="detail-item full-width">
            ...
            <span>{record.treatmentDone || 'N/A'}</span>
          </div>
        </div>
      </section>
    </div>
